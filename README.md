...
[Encontro 1](https://github.com/vinrodr/Intro-R-fev-24/blob/main/Encontros/Encontro%201.Rmd). Preparação do ambiente computacional: R e RStudio. Introdução à gramática R: conceitos e recursos. Melhores práticas para programar. (em [Rpubs](https://rpubs.com/vinrodr/encontro_1_introR))
