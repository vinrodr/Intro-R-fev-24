...
> [!TIP]
> Comentem seu código! O console do R ignora qualquer texto colocado na linha após um _hashtag_ (#) e interpreta como um 'não-comando'. O uso de comentários é uma boa prática para qualquer programador, pois facilita a compreensão do script para outras pessoas e, talvez mais importante, ajuda na lembrança das escolhas que vocês tomaram na escrita. Acredite, vocês não irão lembrar do que fizeram uma semana após terem escrito.
