...
Para baixar R, vá para [CRAN](https://cloud.r-project.org/) e siga as seguintes etapas:
...
updateR()
```
Por último, caso os pacotes (bibliotecas) sejam atualizados, o R envia um alerta na linha de comando ao carregá-los. Você poderá executar a atualização por meio do install.packages() da linha de comando ou por meio da barra de menu: Tools > check for packages update.
