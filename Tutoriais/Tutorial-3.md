...
```
> [!NOTE]
> Primeiro eu coloquei um comando para que o valor na primeira posição da lista fosse mostrado. E o resultado foi o numeral 10. Na segunda linha, além de ordenar esta ação, eu guardei o resultado no objeto nota que eu criei pelo **_assignment_**.
